...
#define FINITE_WAITING_TIMEOUT          30000 //finite timeout. after this time the system goes back to idle
                ...
                case UPDATE_STOP:
                  ...
                  if(FSM_State == WAIT_FOR_RESPONSE){
                    if(sysMode == MS_CALIBRATION){
                      ...
                      TarMsg =  "To stop running sequence tap the STOP button twice<br />";
                    }
