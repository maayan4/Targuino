   ...
   case PULL_STATE:
    ...
    if(delayHasPassed && checkTime(VMEASURE_SAMPLE_TIME)){  
     ...
     if(delayHasPassed && timeGuard > 1000){
      Serial2.print("DHP: "); Serial2.print(delayHasPassed); Serial2.print(" timeGuard:"); Serial2.print(timeGuard); Serial2.print(" stopsig:"); Serial2.print(stopSignal); Serial2.print(" Distance:"); Serial2.println(distance_from_edge);      
      tBeginMovement = CurrentTime;
      /////////////////////////////////ONLY IF THERE IS NO SENSOR!
      if(!MS){ 
        sysIn = desiredIn;
        distance_from_edge = distance_from_edge - 6;
      }
      /////////////////////////////////ONLY IF THERE IS NO SENSOR!
     }
    break;
...
void serialEvent() {
  ...
  if(processedMSG == previousRxMsg && OneTimeFlag == true){ //drop double messages
    Serial2.print("Message number "); Serial2.print(recBuff[3]); Serial2.println(" dropped");
    OneTimeFlag = false;
    return;
    } 
