...
void loop(){
  switch (FSM_State) {
   ...
   case PULL_AND_COUNT:
    ...
    if(timeGuard > maximumRunTime || stopSignal){ // target probably arrived to the other edge of the rope 
      ...
      lTrack = floor(RunLength / numOfmagnets); //save lTrack. In the future - maybe save to EEPROM
   ...
   case PULL_SLOW:
    ...
    if(stopSignal){ //if target arrived to the other side 
      ...
      Serial2.println("Coasting. Master should be pulling now");
      FSM_State = WAIT_FOR_RESPONSE;
      numOfresends = 0;
          ...
          if (c == '\n' && currentLineIsBlank) {
              ...
              switch(out.msgType){
                ...
                case UPDATE_STOP:
                  ...
                  if(FSM_State == PULL_SLOW || FSM_State == PULL_AND_COUNT || FSM_State == PULL_STATE || FSM_State == PULL_SLOWLY){
                    stopSignal = true; 
                  }
                  if(sysMode == MS_IDLE){
  ...
  if(sumsum > 4000){
    Serial2.print(float(CurrentTime / 1000)); Serial2.print(" FSM_State: "); Serial2.print(FSM_State, HEX); Serial2.print(" sysMode: "); Serial2.print(sysMode,HEX); Serial2.print(" LTR_delay: "); Serial2.print(LTR_delay); Serial2.print(" LTR_Velocity: "); Serial2.print(velLTR); Serial2.print(" RTL_delay: "); Serial2.print(RTL_delay); Serial2.print(" RTL_Velocity: "); Serial2.println(velRTL);
    statTmp = CurrentTime;
  }
...
void printXML(EthernetClient cl){
  ...
  cl.print("<TrackLength>"); cl.print(lTrack * ropeRadius / 1000); cl.println("</TrackLength>");
  cl.print("</Targuino>");
}
